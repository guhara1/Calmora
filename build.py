...
산출물: 저장소 루트에 정적 HTML 트리 + sitemap.xml / robots.txt / 404.html + data/incheon/*.json
"""
...
NAV = [
    ...
    ("구군 안내", "/incheon/#gu", [
        ...
        ("미추홀구", "/incheon/michuhol-gu/"), ("연수구", "/incheon/yeonsu-gu/"),
        ("남동구", "/incheon/namdong-gu/"), ("부평구", "/incheon/bupyeong-gu/"),
        ("계양구", "/incheon/gyeyang-gu/"), ("서구", "/incheon/seo-gu/"),
        ("강화군", "/incheon/ganghwa-gun/"), ("옹진군", "/incheon/ongjin-gun/"),
    ]),
    ("생활권", "/incheon/#life", [
        ...
        ("동인천·제물포", "/incheon/life/dongincheon-jemulpo/"),
        ("영종·운서", "/incheon/life/yeongjong-unseo/"),
    ]),
    ("지하철역", "/incheon/#station", [
        ("부평역", "/incheon/station/bupyeong-station/"),
        ("주안역", "/incheon/station/juan-station/"),
        ("인천시청역", "/incheon/station/incheon-cityhall-station/"),
        ("인천대입구역", "/incheon/station/incheon-univ-station/"),
        ("동인천역", "/incheon/station/dongincheon-station/"),
        ("계산역", "/incheon/station/gyesan-station/"),
    ]),
    ("이용 장소", "/incheon/#use", [
        ("자택 이용", "/incheon/use/home/"), ("호텔·숙소 이용", "/incheon/use/hotel/"),
        ("오피스텔 이용", "/incheon/use/officetel/"), ("업무지구 이용", "/incheon/use/business-district/"),
        ("역세권 이용", "/incheon/use/station-area/"), ("야간 예약", "/incheon/use/night/"),
        ("공항권 이용", "/incheon/use/airport-area/"), ("도서 지역 이용", "/incheon/use/island-area/"),
    ]),
    ("공항·도서", "/incheon/airport-island/", [
        ("영종·운서", "/incheon/life/yeongjong-unseo/"),
        ("인천공항", "/incheon/life/incheon-airport/"),
        ("강화", "/incheon/life/ganghwa/"),
        ("옹진 도서", "/incheon/life/ongjin-islands/"),
    ]),
    ("예약 전 확인", "/incheon/check/address/", [
        ("방문 주소 확인", "/incheon/check/address/"), ("건물 출입 방식", "/incheon/check/building-access/"),
        ("추가 이동비 기준", "/incheon/check/travel-fee/"), ("예약 가능 시간", "/incheon/check/time/"),
        ("예약 변경 기준", "/incheon/check/change-policy/"), ("개인정보 처리 기준", "/incheon/check/privacy/"),
        ("불법·선정적 서비스 불가", "/incheon/check/service-policy/"), ("고객 유의사항", "/incheon/check/customer-notice/"),
    ]),
    ("문의하기", "/incheon/policy/contact/", None),
]
...
def build_nav_html(active=""):
    ...
    return (
        ...
        f'<a class="brand" href="/incheon/"><b>{esc(SITE["brand"])}</b><small>인천 방문형 관리 안내</small></a>'
    ...
    return (
      ...
      '<div class="footer-grid">'
        '<div class="footer-brand">'
          f'<a class="brand" href="/incheon/"><b>{esc(SITE["brand"])}</b></a>'
        ...
        '<div class="footer-col"><h4>지역 안내</h4><ul>'
          '<li><a href="/incheon/">인천 홈</a></li>'
          '<li><a href="/incheon/yeonsu-gu/">연수구</a></li>'
          '<li><a href="/incheon/bupyeong-gu/">부평구</a></li>'
          '<li><a href="/incheon/seo-gu/">서구</a></li>'
          '<li><a href="/incheon/life/songdo-international-city/">송도국제도시</a></li>'
        '</ul></div>'
        '<div class="footer-col"><h4>예약 전 확인</h4><ul>'
          '<li><a href="/incheon/check/address/">방문 주소 확인</a></li>'
          '<li><a href="/incheon/check/travel-fee/">추가 이동비 기준</a></li>'
          '<li><a href="/incheon/check/time/">예약 가능 시간</a></li>'
          '<li><a href="/incheon/check/privacy/">개인정보 처리 기준</a></li>'
        '</ul></div>'
        '<div class="footer-col"><h4>운영 기준</h4><ul>'
          '<li><a href="/incheon/policy/privacy-policy/">개인정보 처리방침</a></li>'
          '<li><a href="/incheon/policy/illegal-service/">불법·선정적 서비스 불가</a></li>'
          '<li><a href="/incheon/policy/authors/">작성자·검수자 안내</a></li>'
          '<li><a href="/incheon/policy/contact/">문의하기</a></li>'
...
USECASE_DETAIL_LIST = [
    ("자택 이용", "/incheon/use/home/", "공동현관 비밀번호와 정확한 동·호수, 방문 차량 등록 여부를 확인합니다. 단독·다세대는 건물 외형과 골목 동선을 함께 알려주시면 도착이 빨라집니다."),
    ("호텔·숙소 이용", "/incheon/use/hotel/", "객실 호수와 프런트 출입 절차, 숙소의 외부 방문 정책을 확인합니다. 체크인 상태와 로비 위치를 미리 알려주시면 대기 시간을 줄일 수 있습니다."),
    ("오피스텔 이용", "/incheon/use/officetel/", "관리실 규정과 공동현관·엘리베이터 카드, 방문 주차 가능 여부를 확인합니다. 동·호수와 출입구가 여러 곳인 경우 정확한 출입구를 함께 확인합니다."),
    ("업무지구 이용", "/incheon/use/business-district/", "건물 출입증과 로비 보안, 예약 가능 시간대를 확인합니다. 주중 업무 시간과 그 외 시간대의 출입 방식이 다를 수 있습니다."),
]
...
def customer_notice_html():
    return ('<h2>고객 유의사항</h2>'
            ...
            '자세한 기준은 <a href="/incheon/check/customer-notice/">고객 유의사항</a>과 '
            '<a href="/incheon/check/change-policy/">예약 변경 기준</a>에서 확인할 수 있습니다.</p>')
...
def policy_para():
    return ('<h3>운영 기준 · 개인정보 · 불법 서비스 불가</h3>'
            ...
            '<a href="/incheon/policy/privacy-policy/">개인정보 처리방침</a>과 '
            '<a href="/incheon/policy/illegal-service/">불법·선정적 서비스 불가 안내</a>에서 확인할 수 있습니다.</p>')
...
def gu_card(g):
    ...
    return (f'<a class="card" href="/incheon/{g["slug"]}/">'
...
def life_card(l):
    return (f'<a class="card" href="/incheon/life/{l["slug"]}/">'
            f'<h3>{esc(l["name"])}</h3><p>{esc(clamp(l["focus"], 60))}</p>'
            f'<span class="card-meta">{TYPE_LABEL[l["type"]]} →</span></a>')

def use_card(u):
    return (f'<a class="card" href="/incheon/use/{u["slug"]}/">'
...
def build_main():
    ...
    hero = (
      ...
      '<div class="hero-cta">'
        ...
        '<a class="btn btn-ghost" href="/incheon/check/address/">예약 전 확인</a>'
      '</div>'
    ...
    check_section = section("예약 전 확인해야 할 내용",
        ...
        '<p><a class="btn btn-ghost" href="/incheon/check/address/">예약 전 확인 전체 보기 →</a></p>',
        idattr="check")
...
def build_region_page(*, path, h1, title, desc, name, focus, type_,
    ...
    life_html = ""
    if life_list:
        items = "".join(f'<li><a href="/incheon/life/{s}/">{esc(n)}</a></li>' for n, s in life_list)
...
def build_gu(g):
    ...
    related = [(a["name"]+" 안내", f"/incheon/{slug}/{a['slug']}/") for a in gu_areas[:4]]
    related += [("예약 전 방문 주소 확인", "/incheon/check/address/"),
                ("이용 장소별 안내", "/incheon/use/home/")]
    aside_links = [(l["name"], f"/incheon/life/{l['slug']}/") for l in LIFE if l["gu"] == slug][:5] \
                  or [("인천 홈", "/incheon/")]
    aside_links += [("추가 이동비 기준", "/incheon/check/travel-fee/")]
...
def build_area(a):
    ...
    related = [(gu["name"]+" 전체", f"/incheon/{a['gu']}/"),
               (a["life"]+" 생활권", f"/incheon/life/{a['lifeslug']}/"),
               ("예약 전 방문 주소 확인", "/incheon/check/address/"),
               ("추가 이동비 기준", "/incheon/check/travel-fee/")]
    aside_links = [(gu["name"], f"/incheon/{a['gu']}/"),
                   (a["life"]+" 생활권", f"/incheon/life/{a['lifeslug']}/"),
                   ("이용 장소별 안내", "/incheon/use/hotel/")]
    ...
    build_region_page(
        ...
        crumbs=[("인천 홈","/incheon/"),(gu["name"], f"/incheon/{a['gu']}/"),(name, path)],
...
def build_life(l):
    ...
    related = [(gu["name"]+" 전체", f"/incheon/{l['gu']}/"),
               ("예약 전 방문 주소 확인", "/incheon/check/address/"),
               ("추가 이동비 기준", "/incheon/check/travel-fee/"),
               ("문의하기", "/incheon/policy/contact/")]
    # 관련 대표지역
    for a in AREAS:
        if a["lifeslug"] == l["slug"]:
            related.insert(1, (a["name"]+" 안내", f"/incheon/{a['gu']}/{a['slug']}/"))
    aside_links = [(gu["name"], f"/incheon/{l['gu']}/"),
                   ("이용 장소별 안내", "/incheon/use/hotel/"),
                   ("예약 가능 시간", "/incheon/check/time/")]
    ...
    build_region_page(
        ...
        crumbs=[("인천 홈","/incheon/"),("생활권","/incheon/#life"),(name, path)],
        related=related, aside_links=aside_links, authority=authority, faqs=faqs,
...
def build_station(s):
    ...
    related = [(gu["name"]+" 전체", f"/incheon/{s['gu']}/"),
               (s["life"]+" 생활권", f"/incheon/life/{s['lifeslug']}/"),
               ("역세권 이용 안내", "/incheon/use/station-area/"),
               ("예약 전 방문 주소 확인", "/incheon/check/address/")]
    aside_links = [(gu["name"], f"/incheon/{s['gu']}/"),
                   (s["life"]+" 생활권", f"/incheon/life/{s['lifeslug']}/"),
                   ("추가 이동비 기준", "/incheon/check/travel-fee/")]
    faqs = [
    ...
    build_region_page(
        ...
        crumbs=[("인천 홈","/incheon/"),("지하철역","/incheon/#station"),(name, path)],
...
# ---- 이용 장소 페이지 ----
def build_use(u):
    name = u["name"]; path = f"/incheon/use/{u['slug']}/"
    ...
    hero = ('<section class="hero"><div class="container"><div class="hero-grid">'
      ...
      '<a class="btn btn-ghost" href="/incheon/check/address/">예약 전 확인</a></div></div>'
    ...
    body = (hero + breadcrumb_html([("인천 홈","/incheon/"),("이용 장소","/incheon/#use"),(name, path)]) +
      ...
      '<h2>권역별 차이</h2>'
      '<ul><li><a href="/incheon/life/songdo-international-city/">신도시(송도·청라·검단)</a> — 오피스텔·공동현관·주차 등록</li>'
      '<li><a href="/incheon/life/bupyeong-station-market/">원도심·역세권(부평·주안)</a> — 도로명 주소·골목 동선</li>'
      '<li><a href="/incheon/life/incheon-airport/">공항권(영종·인천공항)</a> — 이동 시간·추가 이동비</li>'
      '<li><a href="/incheon/life/ganghwa/">도서권(강화·옹진)</a> — 방문 가능 여부·이동 일정</li></ul>'
      ...
      '<h2>관련 예약 전 확인</h2>'
      '<ul><li><a href="/incheon/check/address/">방문 주소 확인</a> · <a href="/incheon/check/building-access/">건물 출입 방식</a></li>'
      '<li><a href="/incheon/check/time/">예약 가능 시간</a> · <a href="/incheon/check/travel-fee/">추가 이동비 기준</a></li></ul>'
      '<h2>관련 생활권·구군</h2>'
      '<p>인천 전역에서 이용 장소 기준을 적용할 수 있습니다. 권역별 대표 생활권으로 바로 이동해 가까운 지역의 안내를 확인하세요.</p>'
      '<ul><li>신도시 — <a href="/incheon/life/songdo-international-city/">송도국제도시</a>, '
      '<a href="/incheon/life/cheongna-international-city/">청라국제도시</a>, <a href="/incheon/life/geomdan-newtown/">검단신도시</a></li>'
      '<li>원도심·역세권 — <a href="/incheon/life/bupyeong-station-market/">부평역·부평시장</a>, '
      '<a href="/incheon/life/juan-dohwa/">주안·도화</a>, <a href="/incheon/life/guwol-incheon-cityhall/">구월·인천시청</a></li>'
      '<li>공항·도서 — <a href="/incheon/life/incheon-airport/">인천공항</a>, '
      '<a href="/incheon/life/ganghwa/">강화</a>, <a href="/incheon/life/ongjin-islands/">옹진 도서</a></li>'
      '<li><a href="/incheon/">인천 구군 전체 보기</a></li></ul>'
      '<h2>예약 전 체크리스트</h2>' + checklist_block(COMMON_CHECK) +
      '<h2>운영 기준 안내</h2>' + policy_para() +
      customer_notice_html() +
      '<h2>자주 묻는 질문</h2>' + faq_html(faqs) +
      ...
      aside_html("이용 장소 바로가기",
                 [(x["name"], f"/incheon/use/{x['slug']}/") for x in USES if x["slug"]!=u["slug"]][:6],
                 [AUTHORITY["privacy"]]) +
      '</div></div></section>')
    schema = [org_node(),
              ...
              breadcrumb_ld([("인천 홈","/incheon/"),("이용 장소","/incheon/#use"),(name, path)]),
...
# ---- 예약 전 확인 페이지 ----
def build_check(c):
    name = c["name"]; path = f"/incheon/check/{c['slug']}/"
    h1 = f"인천 출장마사지 {c['h1']}"
    ...
    body = (hero + breadcrumb_html([("인천 홈","/incheon/"),("예약 전 확인","/incheon/check/address/"),(name, path)]) +
      ...
      '<h3>권역별 차이</h3>'
      '<ul><li><a href="/incheon/life/songdo-international-city/">신도시(송도·청라·검단)</a> — 오피스텔·주차·공동현관</li>'
      '<li><a href="/incheon/life/bupyeong-station-market/">원도심·역세권(부평·주안·구월)</a> — 도로명 주소·골목 동선</li>'
      '<li><a href="/incheon/life/incheon-airport/">공항권(영종·인천공항)</a> — 이동 시간·추가 이동비</li>'
      '<li><a href="/incheon/life/ganghwa/">도서권(강화·옹진)</a> — 방문 가능 여부·이동 일정</li></ul>'
      '<h2>이용 장소별 확인</h2>'
      ...
      '<ul><li><a href="/incheon/use/home/">자택 이용</a> · <a href="/incheon/use/hotel/">호텔·숙소 이용</a></li>'
      '<li><a href="/incheon/use/officetel/">오피스텔 이용</a> · <a href="/incheon/use/business-district/">업무지구 이용</a></li></ul>'
      '<h2>예약 전 체크리스트</h2>' + checklist_block(COMMON_CHECK) +
      '<h2>운영 기준 안내</h2>' + policy_para() +
      '<h2>예약 진행 안내</h2>'
      ...
      aside_html("예약 전 확인 바로가기",
                 [(x["name"], f"/incheon/check/{x['slug']}/") for x in CHECKS if x["slug"]!=c["slug"]],
                 [AUTHORITY["privacy"]]) +
      '</div></div></section>')
    schema = [org_node(),
              {"@type":"WebPage","@id":SITE["url"]+path+"#webpage","url":SITE["url"]+path,"name":title,
               "description":desc,"inLanguage":"ko","isPartOf":{"@id":SITE["url"]+"/#org"},"dateModified":SITE["today"]},
              breadcrumb_ld([("인천 홈","/incheon/"),("예약 전 확인","/incheon/check/address/"),(name, path)]),
...
def policy_body(slug):
    ...
    if slug == "service-standard":
        return ('<p>본 사이트는 인천 지역 방문형 관리 안내를 제공합니다. 모든 안내는 생활권·역세권·이용 장소·예약 전 확인사항을 '
                ...
                '<a href="/incheon/check/change-policy/">예약 변경 기준</a>과 <a href="/incheon/check/time/">예약 가능 시간</a>에서 확인할 수 있습니다.</p>'
                '<h3>권역별 안내</h3><p>인천은 신도시·원도심·공항권·도서권의 이동 기준이 달라, 예약 전 확인 항목도 권역마다 다릅니다. '
                '<a href="/incheon/">인천 홈</a>에서 구군·생활권별 안내를 확인할 수 있습니다.</p>')
    if slug == "illegal-service":
        return ('<p>본 사이트는 불법·선정적 서비스를 제공하거나 안내하지 않습니다. 성매매 등 불법 행위를 암시하는 표현, '
                ...
                '<a href="/incheon/policy/content-standard/">콘텐츠 작성 기준</a>과 <a href="/incheon/policy/privacy-policy/">개인정보 처리방침</a>에서 확인할 수 있습니다.</p>')
    if slug == "content-standard":
        return ('<p>모든 색인 페이지는 지역명만 바꾸지 않고 생활권·역세권·이용 장소·예약 전 확인사항을 다르게 구성합니다. '
                ...
                '<a href="/incheon/policy/authors/">작성자·검수자 안내</a>에서 확인할 수 있습니다.</p>')
    if slug == "authors":
        return (f'<p>본 사이트의 지역 안내 콘텐츠는 <b>{esc(SITE["author"])}</b>가 작성하고 '
                ...
                '수정일은 각 페이지 하단에 표시합니다. 콘텐츠 작성 원칙은 <a href="/incheon/policy/content-standard/">콘텐츠 작성 기준</a>을 따릅니다.</p>')
    if slug == "contact":
...
def build_policy(p):
    name = p["name"]; path = f"/incheon/policy/{p['slug']}/"
    ...
    body = ('<section class="section"><div class="container">'
      + breadcrumb_html([("인천 홈","/incheon/"),("운영 기준","/incheon/policy/service-standard/"),(name, path)]).replace('class="breadcrumb"','class="breadcrumb"') +
      f'<div class="prose"><h1>{esc(p["h1"])}</h1>' + policy_body(p["slug"]) +
      eeat_block() + '</div></div></section>')
    schema = [org_node(),
              {"@type":"WebPage","@id":SITE["url"]+path+"#webpage","url":SITE["url"]+path,"name":title,
               "description":desc,"inLanguage":"ko","isPartOf":{"@id":SITE["url"]+"/#org"},"dateModified":SITE["today"]},
              breadcrumb_ld([("인천 홈","/incheon/"),("운영 기준","/incheon/policy/service-standard/"),(name, path)])]
    write_page(path, document(path=path, title=title, description=desc, body=body,
                              schema_nodes=schema, noindex=noindex))

# ---- 공항·도서 허브 ----
def build_airport_island_hub():
    path = "/incheon/airport-island/"
    name = "공항·도서 안내"
    title = f"인천 공항·도서 안내｜영종·인천공항·강화·옹진 - {SITE['brand']}"
    desc = clamp("인천 공항권·도서권 방문 안내. 영종·인천공항·강화·옹진 이동 시간·추가 이동비 확인", 80)
    cards = [
        ("영종·운서","/incheon/life/yeongjong-unseo/","공항 배후 신도시·숙소권"),
        ("인천공항","/incheon/life/incheon-airport/","터미널·인접 숙소, 이동 시간 확인"),
        ("강화","/incheon/life/ganghwa/","외곽·도서형, 차량 이동·사전 예약"),
        ("옹진 도서","/incheon/life/ongjin-islands/","영흥·백령·대청·연평·자월 도서권"),
    ]
    ...
    body = (hero + breadcrumb_html([("인천 홈","/incheon/"),(name, path)]) +
      ...
      '먼저 협의하는 것이 좋습니다. 자세한 기준은 <a href="/incheon/use/airport-area/">공항권 이용</a>과 '
      '<a href="/incheon/check/travel-fee/">추가 이동비 기준</a>에서 확인할 수 있습니다.</p>'
      '<h2>도서권 이용 안내</h2>'
      ...
      '<a href="/incheon/use/island-area/">도서 지역 이용</a>, <a href="/incheon/life/ganghwa/">강화</a>, '
      '<a href="/incheon/life/ongjin-islands/">옹진 도서</a>에서 확인할 수 있습니다.</p>'
      '<h2>예약 전 체크리스트</h2>' + checklist_block(COMMON_CHECK) +
      customer_notice_html() +
      '<h2>관련 구군 · 예약 전 확인</h2>'
      '<ul><li>공항권 — <a href="/incheon/jung-gu/">중구</a>, <a href="/incheon/jung-gu/yeongjong-area/">영종</a>, '
      '<a href="/incheon/jung-gu/incheon-airport-area/">인천공항</a></li>'
      '<li>도서권 — <a href="/incheon/ganghwa-gun/">강화군</a>, <a href="/incheon/ongjin-gun/">옹진군</a></li>'
      '<li>확인 — <a href="/incheon/check/travel-fee/">추가 이동비 기준</a>, <a href="/incheon/check/time/">예약 가능 시간</a></li></ul>'
    ...
    schema = [org_node(),
              ...
              breadcrumb_ld([("인천 홈","/incheon/"),(name, path)]),
              image_ld(SITE["hero_img"], "인천 공항·도서 안내 이미지")]
    write_page(path, document(path=path, title=title, description=desc, body=body, schema_nodes=schema))

# ---- 2026 개편 대응(draft / noindex) ----
def build_reform(r):
    name = r["name"]; path = f"/incheon/{r['slug']}/"
    ...
    body = ('<section class="section"><div class="container"><div class="prose">'
      + breadcrumb_html([("인천 홈","/incheon/"),(name+" 준비", path)]) +
      ...
      '<h2>현재 예약 안내</h2><ul>'
      + "".join(
          f'<li><a href="/incheon/{g["slug"]}/">{esc(g["name"])} 안내</a></li>'
...
def build_root_redirect():
    html_doc = (
      ...
      '<title>Calmora · 인천 방문형 관리 안내</title>'
      '<meta name="description" content="Calmora 인천 방문형 관리(출장마사지·홈타이) 권역별 예약 안내">'
      '<link rel="canonical" href="' + SITE["url"] + '/incheon/">'
      '<meta http-equiv="refresh" content="0; url=/incheon/">'
      '</head><body><p><a href="/incheon/">인천 방문형 관리 안내로 이동</a></p>'
      '<script>location.replace("/incheon/");</script></body></html>')
    with open(os.path.join(ROOT, "index.html"), "w", encoding="utf-8") as f:
        f.write(html_doc)

def collect_urls():
    urls = []  # (path, priority, noindex)
    urls.append(("/incheon/", "1.0", False))
    for g in GUS: urls.append((f"/incheon/{g['slug']}/", "0.8", False))
    for a in AREAS: urls.append((f"/incheon/{a['gu']}/{a['slug']}/", "0.7", False))
    for l in LIFE: urls.append((f"/incheon/life/{l['slug']}/", "0.7", False))
    for s in STATIONS: urls.append((f"/incheon/station/{s['slug']}/", "0.6", False))
    for u in USES: urls.append((f"/incheon/use/{u['slug']}/", "0.6", False))
    for c in CHECKS: urls.append((f"/incheon/check/{c['slug']}/", "0.6", False))
    for p in POLICIES: urls.append((f"/incheon/policy/{p['slug']}/", "0.4", False))
    urls.append(("/incheon/airport-island/", "0.7", False))
    for r in REFORM: urls.append((f"/incheon/{r['slug']}/", "0.1", True))  # noindex → 제외
    return urls
...
def build_robots():
    txt = ("User-agent: *\n"
           "Allow: /\n"
           "Disallow: /incheon/jemulpo-gu/\n"
           "Disallow: /incheon/yeongjong-gu/\n"
           "Disallow: /incheon/geomdan-gu/\n\n"
...
def build_404():
    body = ('<section class="hero"><div class="container"><div class="prose" style="text-align:center;max-width:640px;margin-inline:auto">'
      ...
      '<p><a class="btn btn-gold" href="/incheon/">인천 홈으로</a> '
...
def dump_data():
    """spec section 25: /data/incheon/*.json 산출"""
